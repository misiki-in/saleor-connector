...
/**
 * SaleorConnector — entry point for the Saleor connector. Exposes all 43 services.
 * Methods for resources Saleor does not expose throw `NotSupportedError` (see README coverage table).
 */
...
export function createClient(config: ConnectorConfig) { return new SaleorConnector(config) }
